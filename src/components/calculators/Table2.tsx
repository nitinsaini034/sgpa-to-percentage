    ...
    <div>
      ...
      <table className="table-auto w-full border border-gray-300 border-collapse">
        <thead className="bg-gray-100">
          <tr>
            <th className="border border-black px-4 py-2 text-center">CGPA(5.0 Grade)</th>
            <th className="border border-black px-4 py-2 text-center">Percentage in 5.0 Grade Scale
</th>
          </tr>
        </thead>
        <tbody className="text-center">
          ...
          <tr>
            ...
            <td className="border border-black px-4 py-2">90%</td>
          </tr>
          <tr>
            <td className="border border-black px-4 py-2">4.0 CGPA</td>
            <td className="border border-black px-4 py-2">80%</td>
          </tr>
          <tr>
            <td className="border border-black px-4 py-2">3.5 CGPA</td>
            <td className="border border-black px-4 py-2">70%</td>
          </tr>
          <tr>
