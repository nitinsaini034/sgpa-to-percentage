      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-6 text-card-foreground leading-relaxed">
          <section>
            ...
            <p>
              By accessing and using sgpa2percentage, you accept and agree to be bound by the terms and
          ...
          <section>
            ...
            <p>
              sgpa2percentage provides a collection of online academic calculation tools. You understand and agree that
              the Service is provided "AS-IS" and that sgpa2percentage assumes no responsibility for the timeliness,
          ...
          <section>
            ...
            <p>
              While we strive to provide accurate calculations, sgpa2percentage makes no warranty that the Service will be error-free or uninterrupted. The tools are provided for guidance only. Users are advised to verify all
              calculations with official academic sources or guidelines. sgpa2percentage is not responsible for any
          ...
          <section>
            ...
            <p>
              ...
              property of sgpa2percentage and its licensors. The Service is protected by copyright, trademark, and
          ...
          <section>
            ...
            <p>
              In no event shall sgpa2percentage, nor its directors, employees, partners, agents, suppliers, or affiliates,
          ...
          <section>
            ...
            <p>
              sgpa2percentage reserves the right, at its sole discretion, to modify or replace these Terms at any time.
